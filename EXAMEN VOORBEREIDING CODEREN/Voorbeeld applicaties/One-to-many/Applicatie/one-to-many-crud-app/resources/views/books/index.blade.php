<x-app-layout>
    ...
    <div class="flex flex-col gap-2 p-10">
        <div class="flex flex-row justify-start">
            <a class="bg-background border border-black bg-[#64CCC5] text-[#04364A] font-semibold" href="{{ route('books.create') }}">Book aanmaken</a>
        </div>
        ...
        <div class="flex flex-col p-3 gap-3 border border-black">
            ...
            <div class="flex flex-row bg-background border border-black bg-[#64CCC5]">
                <a href="{{ route('books.show', ['book' => $book]) }}" class="grow flex flex-row p-3">
                    <span class="font-semibold text-[#04364A]">{{ $book->title }}</span>
                </a>
                <div class="justify-end flex flex-row p-3 gap-3 ">
                    <a href="{{ route('books.edit', ['book' => $book]) }}" class="border px-5 bg-yellow-400 text-white border-black font-semibold">Edit</a>
